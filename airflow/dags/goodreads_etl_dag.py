...
default_args = {
    ...
    'start_date' : datetime(2022, 2, 19, 0, 0, 0, 0),
    'end_date' : datetime(2022, 2, 20, 0, 0, 0, 0),
...
load_author_table_reviews = LoadAnalyticsOperator(
    ...
    redshift_conn_id = 'redshift',
    sql_query = [AnalyticsQueries.populate_authors_reviews.format('2022-02-01 00:00:00.000000', '2022-02-28 00:00:00.000000')],
    dag=dag
)
...
load_author_table_ratings = LoadAnalyticsOperator(
    ...
    redshift_conn_id = 'redshift',
    sql_query = [AnalyticsQueries.populate_authors_ratings.format('2022-02-01 00:00:00.000000', '2022-02-28 00:00:00.000000')],
    dag=dag
)
...
load_book_table_reviews = LoadAnalyticsOperator(
    ...
    redshift_conn_id = 'redshift',
    sql_query = [AnalyticsQueries.populate_books_reviews.format('2022-02-01 00:00:00.000000', '2022-02-28 00:00:00.000000')],
    dag=dag
)
...
load_book_table_ratings = LoadAnalyticsOperator(
    ...
    redshift_conn_id = 'redshift',
    sql_query = [AnalyticsQueries.populate_books_ratings.format('2022-02-01 00:00:00.000000', '2022-02-28 00:00:00.000000')],
    dag=dag
)
